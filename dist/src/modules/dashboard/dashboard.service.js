...
const getProviderDashboardFromDB = async (providerId) => {
    ...
    const confirmedOrders = await prisma.rentalOrder.count({
        where: {
            gear: {
                providerId,
            },
    ...
    const returnedOrders = await prisma.rentalOrder.count({
        where: {
            gear: {
                providerId,
            },
...
const getCustomerDashboardFromDB = async (customerId) => {
    ...
    const cancelledOrders = await prisma.rentalOrder.count({
        where: {
            customerId,
            status: "CANCELLED",
        },
